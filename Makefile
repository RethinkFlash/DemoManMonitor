...
SOURCES = EscentsMonitor.cpp AlsaSource.cpp AlsaSink.cpp PocketSphinxKWS.cpp
...
EscentsMonitor: $(SOURCES) main.cpp
	$(CXX) $(CXX_FLAGS) $(INCLUDES) $(SOURCES) main.cpp -o $(OUTPUT) $(LIBS)

run: EscentsMonitor
	./EscentsMonitor -hmm $(MODELS_DIR)/hub4wsj_sc_8k/ -dict $(MODELS_DIR)/cmu07a.dic -lm $(MODELS_DIR)/wsj0vp.5000.DMP
